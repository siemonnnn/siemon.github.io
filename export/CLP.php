...
$query = "SELECT start_date, end_date FROM process_log LIMIT 1";
...
$sql_que = "SELECT
            ...
            . " AND conf.lolos=1 "
            . " ORDER BY conf.from_itemset DESC, conf.confidence DESC";
...
$pdf->Ln();
$pdf->Cell(5, 1, 'Dari Tanggal : '.$_GET['start'], 0, 1, 'C');
$pdf->Cell(4, 1, 'Sampai : '.$_GET['end'], 0, 1, 'C');
